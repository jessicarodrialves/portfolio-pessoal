    ...
    if (!campoEmail.value.match(emailRegex)) {
        txtEmail.innerHTML = "Digite um E-mail válido no formato: teste@exemplo.com";
        campoEmail.focus();
        return;
    }else{
        txtEmail.innerHTML = "";
    ...
    if(campoMessage.value.trim().length === 0 ){
        txtMessage.textContent = "A mensagem precisa ser inserida";
        campoMessage.focus();
        return;
    }else{
